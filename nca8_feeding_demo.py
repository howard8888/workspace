...
from nca8_suckle_extraction_attention_demo import run_extraction_attention_menu_v1
from nca8_suckle_extraction_learning_demo import run_extraction_learning_menu_v1
from nca8_suckle_extraction_outcomes_demo import run_suckle_extraction_outcome_menu_v1
...
from nca8_sustained_feeding_demo import run_sustained_feeding_menu_v1
from nca8_rest_demo import run_rest_menu_v1
...
def run_feeding_detail_menu_v1() -> None:
    ...
    while True:
        ...
        if choice == "35":
            ...
            continue
        if choice == "34":
            run_sustained_feeding_menu_v1()
            continue
        if choice == "33":
            run_extraction_learning_menu_v1()
            continue
        if choice == "32":
            run_extraction_attention_menu_v1()
            continue
        if choice == "31":
            run_suckle_extraction_outcome_menu_v1()
            continue
        if choice == "30":
