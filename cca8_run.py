...
#       - the large live observation-injection function and contextual auto-retrieval policy remain here until Phase 3.
...
def inject_obs_into_working_world(ctx: Ctx, env_obs: EnvObservation) -> dict[str, Any]:
    ...
    if getattr(ctx, "working_mapsurface", True):
        ...
        # The live entity/predicate/cue injection remains in this runner for Phase 3.
        # NavPatch references, ambiguity Scratch/zoom, salience, SurfaceGrid, grid-derived
        # predicates, and NavSummary are delegated to cca8_working_memory.
        if bool(getattr(ctx, "navpatch_enabled", False)):
            try:
                cca8_working_memory.update_working_navpatch_refs_v1(
                    ctx,
                    env_obs,
                    ww,
            ...
            try:
                cca8_working_memory.update_working_navpatch_scratch_zoom_v1(
                    ctx,
                    env_obs,
                    ww,
        ...
        try:
            cca8_working_memory.update_working_salience_surfacegrid_v1(
                ctx,
                env_obs,
                ww,
                changed_entities=changed_entities,
