...
class LearningCapabilityV1:
    ...
    def live_consumer(self) -> str:
        """Identify the one implemented partial seam without fabricating 24 actors."""
        return ("Nca8BodySensoryModuleV1.learning_hook -> RightingLearningHookV1.reconcile (source-side no-learning seam only)"
    ...
    def test_destination(self) -> str:
        ...
        return ("tests/test_nca8_learning.py and tests/test_nca8_learning_demo.py; future durable proof at " + self.promotion_phase
