...
def test_registry_lists_real_production_modules_without_changing_host_behavior_count():
    ...
    assert nca8_prediction.__version__ == "0.4.1" and nca8_runtime.__version__ == "0.16.0"
    assert nca8_menu.__version__ == "0.22.0"
    ...
    assert len(cca8_run._cca8_component_rows()) == 94 and len(cca8_run.PRIMITIVES) == 8
