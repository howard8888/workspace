...
def test_registry_lists_real_production_modules_without_changing_host_behavior_count():
    ...
    assert nca8_prediction.__version__ == "0.2.0" and nca8_runtime.__version__ == "0.9.1"
    assert nca8_menu.__version__ == "0.10.1"
    ...
    assert len(cca8_run._cca8_component_rows()) == 71 and len(cca8_run.PRIMITIVES) == 8
