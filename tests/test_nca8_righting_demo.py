...
def test_registry_lists_real_production_modules_without_changing_host_behavior_count():
    ...
    assert nca8_righting.__version__ == "0.2.0" and nca8_righting_demo.__version__ == "0.1.0"
    assert nca8_maps.__version__ == nca8_executive.__version__ == "0.3.0"
    assert nca8_sensory.__version__ == "0.4.0"
    assert nca8_prediction.__version__ == "0.2.0" and nca8_runtime.__version__ == "0.9.0"
    assert nca8_menu.__version__ == "0.10.0"
    ...
    assert len(cca8_run._cca8_component_rows()) == 70 and len(cca8_run.PRIMITIVES) == 8
