...
def test_registry_lists_real_production_modules_without_changing_host_behavior_count():
    ...
    import nca8_runtime
    assert cca8_run.__version__ == "0.30.24"
    assert nca8_righting.__version__ == "0.3.1" and nca8_righting_demo.__version__ == "0.1.1"
    assert nca8_maps.__version__ == "0.3.0" and nca8_executive.__version__ == "0.6.0"
    assert nca8_sensory.__version__ == "0.6.0"
    assert nca8_prediction.__version__ == "0.4.1" and nca8_runtime.__version__ == "0.13.0"
    assert nca8_menu.__version__ == "0.17.0"
    ...
    assert len(cca8_run._cca8_component_rows()) == 86 and len(cca8_run.PRIMITIVES) == 8
