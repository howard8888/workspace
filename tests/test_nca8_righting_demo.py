...
def test_registry_lists_real_production_modules_without_changing_host_behavior_count():
    ...
    assert nca8_maps.__version__ == "0.3.0" and nca8_executive.__version__ == "0.5.0"
    assert nca8_sensory.__version__ == "0.6.0"
    assert nca8_prediction.__version__ == "0.3.0" and nca8_runtime.__version__ == "0.12.0"
    assert nca8_menu.__version__ == "0.15.0"
    ...
    assert len(cca8_run._cca8_component_rows()) == 82 and len(cca8_run.PRIMITIVES) == 8
