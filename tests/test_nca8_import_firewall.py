...
_ALLOWED_CCA8_IMPORTS: dict[str, frozenset[str]] = {
    ...
    "nca8_feeding.py": frozenset({"cca8_motor_contracts", "cca8_navmap_kernel"}),
    "nca8_feeding_state.py": frozenset({"cca8_motor_contracts"}),
    "nca8_sustained_feeding_demo.py": frozenset({"cca8_cli", "cca8_support_world"}),
    "nca8_feeding_demo.py": frozenset({"cca8_cli", "cca8_motor_contracts", "cca8_support_world"}),
    "nca8_followmom.py": frozenset({"cca8_motor_contracts", "cca8_navmap_kernel"}),
    "nca8_followmom_demo.py": frozenset({"cca8_cli", "cca8_motor_contracts", "cca8_navmap_kernel", "cca8_support_world"}),
    "nca8_followmom_qualification.py": frozenset({"cca8_cli", "cca8_motor_contracts", "cca8_support_world"}),
    "nca8_maternal.py": frozenset({"cca8_motor_contracts", "cca8_navmap_kernel"}),
    "nca8_maternal_outcomes.py": frozenset({"cca8_motor_contracts", "cca8_navmap_kernel"}),
    "nca8_maternal_attention.py": frozenset({"cca8_motor_contracts"}),
    "nca8_maternal_attention_demo.py": frozenset({"cca8_cli", "cca8_motor_contracts", "cca8_support_world"}),
    "nca8_maternal_learning.py": frozenset({"cca8_motor_contracts"}),
    "nca8_maternal_learning_demo.py": frozenset({"cca8_cli", "cca8_motor_contracts", "cca8_support_world", "cca8_navmap_kernel"}),
    ...
    "nca8_oral_demo.py": frozenset({"cca8_cli", "cca8_motor_contracts", "cca8_support_world"}),
    "nca8_oral_extraction_control_demo.py": frozenset({"cca8_cli", "cca8_motor_contracts", "cca8_support_world"}),
    "nca8_oral_extraction_demo.py": frozenset({"cca8_cli", "cca8_motor_contracts", "cca8_support_world"}),
    "nca8_oral_seal_demo.py": frozenset({"cca8_cli", "cca8_motor_contracts", "cca8_support_world"}),
    "nca8_suckle_extraction_demo.py": frozenset({"cca8_cli", "cca8_support_world"}),
    "nca8_suckle_extraction_attention.py": frozenset({"cca8_motor_contracts"}),
    "nca8_suckle_extraction_attention_demo.py": frozenset({"cca8_cli"}),
    "nca8_suckle_extraction_learning.py": frozenset({"cca8_motor_contracts"}),
    "nca8_suckle_extraction_learning_demo.py": frozenset({"cca8_cli"}),
    "nca8_suckle_extraction_outcomes.py": frozenset({"cca8_motor_contracts"}),
    "nca8_suckle_extraction_outcomes_demo.py": frozenset({"cca8_cli"}),
    "nca8_suckle_attention.py": frozenset({"cca8_motor_contracts"}),
    "nca8_suckle_learning.py": frozenset({"cca8_motor_contracts"}),
    "nca8_suckle_learning_demo.py": frozenset({"cca8_cli"}),
    "nca8_suckle_attention_demo.py": frozenset({"cca8_cli"}),
    "nca8_suckle_outcomes.py": frozenset({"cca8_motor_contracts", "cca8_navmap_kernel"}),
    "nca8_suckle_outcomes_demo.py": frozenset({"cca8_cli"}),
    "nca8_suckle.py": frozenset(),
    "nca8_suckle_demo.py": frozenset({"cca8_cli", "cca8_support_world"}),
    ...
    "nca8_prediction.py": frozenset({"cca8_navmap_kernel"}),
    "nca8_primitives.py": frozenset(),
    "nca8_rest.py": frozenset({"cca8_motor_contracts", "cca8_navmap_kernel"}),
    "nca8_rest_outcomes.py": frozenset({"cca8_motor_contracts", "cca8_navmap_kernel"}),
    "nca8_rest_demo.py": frozenset({"cca8_cli", "cca8_support_world"}),
    ...
    "nca8_seek_attention.py": frozenset({"cca8_motor_contracts"}),
    "nca8_seek_attention_demo.py": frozenset({"cca8_cli", "cca8_support_world"}),
    "nca8_seek_learning.py": frozenset({"cca8_motor_contracts"}),
    "nca8_seek_learning_demo.py": frozenset({"cca8_cli"}),
    "nca8_seek_nipple.py": frozenset({"cca8_navmap_kernel"}),
    "nca8_seek_outcomes.py": frozenset({"cca8_motor_contracts", "cca8_navmap_kernel"}),
    "nca8_seek_outcomes_demo.py": frozenset({"cca8_cli", "cca8_support_world"}),
    "nca8_seek_nipple_demo.py": frozenset({"cca8_cli", "cca8_motor_contracts", "cca8_support_world"}),
    ...
    "nca8_stand_follow_demo.py": frozenset({"cca8_cli", "cca8_motor_contracts", "cca8_support_world"}),
    "nca8_support_dynamics.py": frozenset(),
    "nca8_trace.py": frozenset(),
    "nca8_translation.py": frozenset({"cca8_navmap_kernel"}),
    "nca8_translation_demo.py": frozenset({"cca8_cli", "cca8_motor_contracts", "cca8_support_world"}),
...
def test_flat_nca8_module_set_is_explicit_and_complete() -> None:
    ...
    assert tuple(path.name for path in NCA8_FILES) == (
        ...
        "nca8_executive.py",
        "nca8_feeding.py",
        "nca8_feeding_demo.py",
        "nca8_feeding_state.py",
        "nca8_followmom.py",
        "nca8_followmom_demo.py",
        "nca8_followmom_qualification.py",
        "nca8_handoff.py",
        "nca8_hierarchy.py",
        ...
        "nca8_maps.py",
        "nca8_maternal.py",
        "nca8_maternal_attention.py",
        "nca8_maternal_attention_demo.py",
        "nca8_maternal_learning.py",
        "nca8_maternal_learning_demo.py",
        "nca8_maternal_outcomes.py",
        "nca8_menu.py",
        "nca8_oral_demo.py",
        "nca8_oral_extraction_control_demo.py",
        "nca8_oral_extraction_demo.py",
        "nca8_oral_seal_demo.py",
        ...
        "nca8_rest.py",
        "nca8_rest_demo.py",
        "nca8_rest_outcomes.py",
        "nca8_righting.py",
        "nca8_righting_demo.py",
        "nca8_runtime.py",
        "nca8_scheduler.py",
        "nca8_seek_attention.py",
        "nca8_seek_attention_demo.py",
        "nca8_seek_learning.py",
        "nca8_seek_learning_demo.py",
        "nca8_seek_nipple.py",
        "nca8_seek_nipple_demo.py",
        "nca8_seek_outcomes.py",
        "nca8_seek_outcomes_demo.py",
        "nca8_sensorimotor.py",
        "nca8_sensorimotor_contracts.py",
        "nca8_sensorimotor_demo.py",
        "nca8_sensory.py",
        "nca8_stand_follow_demo.py",
        "nca8_suckle.py",
        "nca8_suckle_attention.py",
        "nca8_suckle_attention_demo.py",
        "nca8_suckle_demo.py",
        "nca8_suckle_extraction_attention.py",
        "nca8_suckle_extraction_attention_demo.py",
        "nca8_suckle_extraction_demo.py",
        "nca8_suckle_extraction_learning.py",
        "nca8_suckle_extraction_learning_demo.py",
        "nca8_suckle_extraction_outcomes.py",
        "nca8_suckle_extraction_outcomes_demo.py",
        "nca8_suckle_learning.py",
        "nca8_suckle_learning_demo.py",
        "nca8_suckle_outcomes.py",
        "nca8_suckle_outcomes_demo.py",
        "nca8_support_dynamics.py",
        "nca8_sustained_feeding_demo.py",
        "nca8_trace.py",
        "nca8_translation.py",
        "nca8_translation_demo.py",
        "nca8_visual.py",
        "nca8_visual_demo.py",
    )
