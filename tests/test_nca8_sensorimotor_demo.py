...
def test_registry_reports_all_production_modules_without_registering_an_smp_as_a_task():
    ...
    assert cca8_run.__version__ == "0.30.14"
    assert nca8_body_targets.__version__ == "0.2.0"
    assert nca8_sensorimotor.__version__ == demo.__version__ == "0.1.0"
    assert nca8_menu.__version__ == "0.8.0"
    ...
    assert len(cca8_run._cca8_component_rows()) == 66
