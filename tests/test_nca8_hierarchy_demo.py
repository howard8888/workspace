...
def test_registry_versions_include_real_modules_and_preserve_legacy_count():
    ...
    assert nca8_hierarchy.__version__ == "0.25.0" and demo.__version__ == "0.5.1"
    assert cca8_motor_contracts.__version__ == "0.7.0"
    assert nca8_sensorimotor_contracts.__version__ == "0.6.0"
    assert nca8_handoff.__version__ == "0.8.0"
    assert len(cca8_run._cca8_component_rows()) == 123
