...
from nca8_outcome_attention_demo import run_outcome_attention_menu_v1
...
H6-B and P16-1G-A are accepted checkpoints. Option 8 also offers the opt-in 1G-B outcome/Attention review.
P16-1G-C and A99 remain open; legacy/default routing is unchanged.
        ...
        try:
            ...
            if choice == "8":
                run_hierarchy_review_menu_v1(
                    ...
                    outcome_attention_menu=run_outcome_attention_menu_v1,
                )
                continue
