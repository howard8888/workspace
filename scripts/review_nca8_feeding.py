...
prediction correspondence without changing that default. The --oral route supplies
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    allowed = (SEEK_NIPPLE_OUTCOME_CASES_V1 if args.seek_outcomes else SEEK_NIPPLE_CASES_V1 if args.seek else
